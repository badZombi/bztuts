...
abstract class OAuth2_Provider
{
	...
	*/	
	public function access($code, $options = array(), $force_mode = FALSE)
	{
		$params = array(
			'client_id' 	=> $this->client_id,
		...
		switch ($this->method)
		{
			...
			case 'POST':
				...
				*/
				...
				$merged_array = array_merge_recursive($_default_opts['options'], $opts);
				$context = stream_context_create($merged_array);
