 ...
 */
$config['site_title']                 = "reddume.com";       // Site Title, example.com
$config['admin_email']                = "reddume@badzombi.com"; // Admin Email, admin@example.com
$config['default_group']              = 'free';           // Default group, use name
